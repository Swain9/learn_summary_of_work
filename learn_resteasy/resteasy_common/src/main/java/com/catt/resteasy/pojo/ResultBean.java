...
public class ResultBean {
    ...
    public static ResultBean error() {
        return build(HttpStatus.SC_INTERNAL_SERVER_ERROR, "FALSE", null);
    }

    public static ResultBean error(String msg) {
        return build(HttpStatus.SC_INTERNAL_SERVER_ERROR, msg, null);
    }
    ...
    public static ResultBean formatToPojo(String jsonData, Class<?> clazz) {
        try {
            ...
            return build(jsonNode.get("code").asInt(), jsonNode.get("msg").asText(), obj);
        } catch (Exception e) {
            return null;
        }
    }
